...
1. Copy `script.csx` to your connector folder
2. Add your Application Insights connection string (optional)
3. Customize the operation logic for your connector
4. Deploy and test
