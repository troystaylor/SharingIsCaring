...
/// <summary>
/// Power A2A Template — Agent-to-Agent Protocol Client
/// 
...
///
/// Supports both A2A protocol bindings:
///   - JSON-RPC: POST to single endpoint with method in body (Work IQ, others)
///   - HTTP+JSON: Standard REST paths (/message:send, /tasks/{id})
///
...
public class Script : ScriptBase
{
    ...
    // Edit these constants for your A2A agent.
    // ========================================
    ...
    private const string MCP_SERVER_NAME = "power-a2a-client";
