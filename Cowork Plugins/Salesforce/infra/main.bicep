...
@description('Salesforce base URL used by the MCP server (for example https://mydomain.my.salesforce.com).')
param salesforceBaseUrl string

@description('Salesforce REST API version (for example v61.0).')
param salesforceApiVersion string = 'v61.0'

var resourceToken = toLower(uniqueString(subscription().id, environmentName, location))
var tags = {
  'azd-env-name': environmentName
  workload: 'salesforce-cowork-mcp'
}
