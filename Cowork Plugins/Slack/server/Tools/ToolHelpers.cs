...
/// <summary>
/// Helpers shared by tool factories: build a JSON-RPC content result, extract
/// typed args from the inbound <c>arguments</c> object, etc.
/// </summary>
internal static class ToolHelpers
{
    /// <summary>Wraps a Slack response into the MCP <c>tools/call</c> result shape.</summary>
    ...
    /// <summary>Build the standard <c>$schema</c> + <c>type:object</c> envelope.</summary>
