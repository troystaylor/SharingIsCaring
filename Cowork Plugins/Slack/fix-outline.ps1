...
param(
    [string]$Source = "C:\Users\troytaylor\OneDrive - Microsoft\SharingIsCaring\Cowork Plugins\Slack\color.png",
    [string]$Out    = "C:\Users\troytaylor\OneDrive - Microsoft\SharingIsCaring\Cowork Plugins\Slack\outline.png",
    [int]$Size      = 32
)
...
# First, downscale to the target size at high quality
...
# Build a new bitmap where every pixel is pure white with original alpha.
...
# Threshold below which we force fully transparent (kills near-transparent halo).
$alphaThreshold = 8
...
# Sanity check: confirm no colored pixels remain
