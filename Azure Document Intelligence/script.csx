...
// ╔══════════════════════════════════════════════════════════════════════════════╗
// ║  Azure Document Intelligence — Power Mission Control Connector             ║
// ║                                                                            ║
// ║  Covers Azure Document Intelligence REST API v4.0 (2024-11-30):            ║
// ║  Document Models (analyze, build, compose, copy), Classifiers,             ║
// ║  Operations, and Service Info.                                             ║
// ║                                                                            ║
// ║  MCP exposes high-value operations only. All operations remain             ║
...
public class Script : ScriptBase
{
    ...
    private static readonly McpServerOptions Options = new McpServerOptions
    {
        ServerInfo = new McpServerInfo
        {
            ...
            Version = "1.0.0",
            Title = "Azure Document Intelligence MCP",
            Description = "Power Mission Control connector for Azure Document Intelligence. Analyze documents using prebuilt and custom models to extract text, tables, key-value pairs, and structured fields."
        },
    ...
    private static readonly MissionControlOptions McOptions = new MissionControlOptions
    {
        ...
        BaseApiUrl = "", // Set dynamically from dynamichosturl
    ...
    private const string CAPABILITY_INDEX = @"[
        {
            ""cid"": ""analyze_document"",
            ""endpoint"": ""/documentModels/{modelId}:analyze"",
            ""method"": ""POST"",
            ""outcome"": ""Analyze a document using a prebuilt or custom model. Available models: prebuilt-read (text), prebuilt-layout (tables+structure), prebuilt-invoice, prebuilt-receipt, prebuilt-idDocument, prebuilt-tax.us.w2, prebuilt-bankStatement, prebuilt-healthInsuranceCard.us, prebuilt-contract, prebuilt-creditCard, prebuilt-check.us, prebuilt-payStub.us"",
            ""domain"": ""analysis"",
            ""requiredParams"": [""modelId""],
            ""optionalParams"": [""urlSource"", ""base64Source"", ""pages"", ""locale"", ""features"", ""queryFields"", ""outputContentFormat""],
            ""schemaJson"": ""{\""type\"":\""object\"",\""properties\"":{\""urlSource\"":{\""type\"":\""string\"",\""description\"":\""URL of the document to analyze\""},\""base64Source\"":{\""type\"":\""string\"",\""description\"":\""Base64-encoded document content\""}}}""
        },
        {
            ""cid"": ""get_analyze_result"",
            ""endpoint"": ""/documentModels/{modelId}/analyzeResults/{resultId}"",
            ""method"": ""GET"",
            ""outcome"": ""Get the result of a document analysis operation including extracted text, tables, and fields"",
            ""domain"": ""analysis"",
            ""requiredParams"": [""modelId"", ""resultId""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""list_models"",
            ""endpoint"": ""/documentModels"",
            ""method"": ""GET"",
            ""outcome"": ""List all document models available in the resource including prebuilt and custom models"",
            ""domain"": ""models"",
            ""requiredParams"": [],
            ""optionalParams"": []
        },
        {
            ""cid"": ""get_model"",
            ""endpoint"": ""/documentModels/{modelId}"",
            ""method"": ""GET"",
            ""outcome"": ""Get details of a specific model including its field schema and supported document types"",
            ""domain"": ""models"",
            ""requiredParams"": [""modelId""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""list_classifiers"",
            ""endpoint"": ""/documentClassifiers"",
            ""method"": ""GET"",
            ""outcome"": ""List all custom document classifiers in the resource"",
            ""domain"": ""classifiers"",
            ""requiredParams"": [],
            ""optionalParams"": []
        },
        {
            ""cid"": ""get_classifier"",
            ""endpoint"": ""/documentClassifiers/{classifierId}"",
            ""method"": ""GET"",
            ""outcome"": ""Get details of a specific document classifier including its document type definitions"",
            ""domain"": ""classifiers"",
            ""requiredParams"": [""classifierId""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""classify_document"",
            ""endpoint"": ""/documentClassifiers/{classifierId}:classify"",
            ""method"": ""POST"",
            ""outcome"": ""Classify a document to identify its type using a custom classifier"",
            ""domain"": ""classifiers"",
            ""requiredParams"": [""classifierId""],
            ""optionalParams"": [""urlSource"", ""base64Source""],
            ""schemaJson"": ""{\""type\"":\""object\"",\""properties\"":{\""urlSource\"":{\""type\"":\""string\""},\""base64Source\"":{\""type\"":\""string\""}}}""
        },
        {
            ""cid"": ""get_classify_result"",
            ""endpoint"": ""/documentClassifiers/{classifierId}/classifyResults/{resultId}"",
            ""method"": ""GET"",
            ""outcome"": ""Get the result of a document classification operation"",
            ""domain"": ""classifiers"",
            ""requiredParams"": [""classifierId"", ""resultId""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""list_operations"",
            ""endpoint"": ""/operations"",
            ""method"": ""GET"",
            ""outcome"": ""List all long-running operations such as model builds and copies"",
            ""domain"": ""operations"",
            ""requiredParams"": [],
            ""optionalParams"": []
        },
        {
            ...
            ""method"": ""GET"",
            ""outcome"": ""Get the status and details of a specific long-running operation"",
            ""domain"": ""operations"",
            ""requiredParams"": [""operationId""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""get_service_info"",
            ""endpoint"": ""/info"",
            ""method"": ""GET"",
            ""outcome"": ""Get resource information including custom model count, limits, and neural model build quotas"",
            ""domain"": ""service"",
            ""requiredParams"": [],
            ""optionalParams"": []
        }
    ...
    {
        // REST operations (non-MCP) pass through directly
        ...
        McOptions.BaseApiUrl = $"{requestUri.Scheme}://{requestUri.Host}/documentintelligence";

        // Forward auth headers
        var customHeaders = new Dictionary<string, string>();
        if (this.Context.Request.Headers.TryGetValues("Ocp-Apim-Subscription-Key", out var apiKeyValues))
            customHeaders["Ocp-Apim-Subscription-Key"] = apiKeyValues.FirstOrDefault() ?? "";
    ...
    private async Task<string> DocIntelApiGetAsync(string path)
    {
    ...
    {
        handler.AddResource("docintel://models", "Document Models",
            "All document models available in this resource, including prebuilt models (read, layout, invoice, receipt, ID, tax forms) and custom-trained models.",
            handler: async (ct) =>
            {
                var content = await DocIntelApiGetAsync("documentModels").ConfigureAwait(false);
                return new JArray { new JObject { ["uri"] = "docintel://models", ["mimeType"] = "application/json", ["text"] = content } };
            },
            annotationsConfig: a => { a["audience"] = new JArray("assistant"); a["priority"] = 0.9; });

        handler.AddResource("docintel://service/info", "Service Info",
            "Resource information including custom model count/limits and neural model build quotas.",
            handler: async (ct) =>
            {
                var content = await DocIntelApiGetAsync("info").ConfigureAwait(false);
                return new JArray { new JObject { ["uri"] = "docintel://service/info", ["mimeType"] = "application/json", ["text"] = content } };
            },
            annotationsConfig: a => { a["audience"] = new JArray("assistant"); a["priority"] = 0.7; });

        handler.AddResource("docintel://classifiers", "Document Classifiers",
            "All custom document classifiers in this resource.",
            handler: async (ct) =>
            {
                var content = await DocIntelApiGetAsync("documentClassifiers").ConfigureAwait(false);
                return new JArray { new JObject { ["uri"] = "docintel://classifiers", ["mimeType"] = "application/json", ["text"] = content } };
            },
            annotationsConfig: a => { a["audience"] = new JArray("assistant"); a["priority"] = 0.6; });

        handler.AddResourceTemplate("docintel://models/{modelId}/schema", "Model Schema",
            "Field definitions and document types for a specific model. Use this to understand what fields a model extracts.",
            handler: async (uri, ct) =>
            {
                var parameters = McpRequestHandler.ExtractUriParameters("docintel://models/{modelId}/schema", uri);
                var modelId = parameters.ContainsKey("modelId") ? parameters["modelId"] : "";
                var content = await DocIntelApiGetAsync($"documentModels/{Uri.EscapeDataString(modelId)}").ConfigureAwait(false);
