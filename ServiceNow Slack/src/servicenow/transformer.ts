...
import { SlackContentRecord, ExternalItem, EVERYONE_ACL } from "../models/types";
...
export function transformSlackRecord(record: SlackContentRecord): ExternalItem {
  ...
  const content = messageText
    ? { value: messageText, type: "text" as const }
    : undefined;
