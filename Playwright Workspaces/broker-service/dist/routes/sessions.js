...
function createSessionsRouter(pool, store) {
    ...
    router.post('/sessions', async (req, res) => {
        try {
            ...
            const session = store.create(instance.browser, instance.context, instance.page, instance.remoteSession, currentUrl, ttl);
            res.status(201).json({
