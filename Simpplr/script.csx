...
public class Script : ScriptBase
{
    ...
    private static readonly McpServerOptions Options = new McpServerOptions
    {
        ServerInfo = new McpServerInfo
        {
            ...
            Version = "1.0.0",
            Title = "Simpplr MCP",
            Description = "Simpplr employee experience platform — content, feeds, sites, users, audiences, alerts, notifications, enterprise search, service desk, and analytics via Model Context Protocol"
        },
    ...
    {
        ServiceName = "simpplr",
        BaseApiUrl = "https://platform.app.simpplr.com/v1/b2b",
    ...
    private const string CAPABILITY_INDEX = @"[
        {""cid"":""get_contents"",""endpoint"":""/content/sites/content"",""method"":""GET"",""outcome"":""Get contents from Simpplr sites with optional filtering"",""domain"":""content"",""requiredParams"":[],""optionalParams"":[""siteId"",""type"",""status"",""limit"",""offset""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""siteId\"":{\""type\"":\""string\""},\""type\"":{\""type\"":\""string\""},\""status\"":{\""type\"":\""string\""},\""limit\"":{\""type\"":\""integer\""},\""offset\"":{\""type\"":\""integer\""}}}""},
        {""cid"":""get_carousel"",""endpoint"":""/content/sites/carousel"",""method"":""GET"",""outcome"":""Get carousel items from Simpplr sites"",""domain"":""content"",""requiredParams"":[],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{}}""},
        {""cid"":""get_topics"",""endpoint"":""/content/sites/topics"",""method"":""GET"",""outcome"":""Get topics from Simpplr sites"",""domain"":""content"",""requiredParams"":[],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{}}""},
        {""cid"":""add_page"",""endpoint"":""/content/sites/{siteId}/content/page"",""method"":""POST"",""outcome"":""Add a new page to a Simpplr site"",""domain"":""content"",""requiredParams"":[""siteId""],""optionalParams"":[""title"",""body"",""categoryId""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""siteId\"":{\""type\"":\""string\""},\""title\"":{\""type\"":\""string\""},\""body\"":{\""type\"":\""string\""},\""categoryId\"":{\""type\"":\""string\""}},\""required\"":[\""siteId\""]}""},
        {""cid"":""update_page"",""endpoint"":""/content/sites/{siteId}/content/{contentId}/page"",""method"":""PATCH"",""outcome"":""Update an existing page in a Simpplr site"",""domain"":""content"",""requiredParams"":[""siteId"",""contentId""],""optionalParams"":[""title"",""body""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""siteId\"":{\""type\"":\""string\""},\""contentId\"":{\""type\"":\""string\""},\""title\"":{\""type\"":\""string\""},\""body\"":{\""type\"":\""string\""}},\""required\"":[\""siteId\"",\""contentId\""]}""},
        {""cid"":""delete_content"",""endpoint"":""/content/sites/{siteId}/content/{contentId}"",""method"":""DELETE"",""outcome"":""Delete content from a Simpplr site"",""domain"":""content"",""requiredParams"":[""siteId"",""contentId""],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""siteId\"":{\""type\"":\""string\""},\""contentId\"":{\""type\"":\""string\""}},\""required\"":[\""siteId\"",\""contentId\""]}""},
        {""cid"":""approve_content"",""endpoint"":""/content/sites/{siteId}/content/{contentId}/approve"",""method"":""POST"",""outcome"":""Approve or reject content in a Simpplr site"",""domain"":""content"",""requiredParams"":[""siteId"",""contentId""],""optionalParams"":[""action"",""comment""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""siteId\"":{\""type\"":\""string\""},\""contentId\"":{\""type\"":\""string\""},\""action\"":{\""type\"":\""string\"",\""enum\"":[\""approve\"",\""reject\""]},\""comment\"":{\""type\"":\""string\""}},\""required\"":[\""siteId\"",\""contentId\""]}""},
        {""cid"":""publish_content"",""endpoint"":""/content/sites/{siteId}/content/{contentId}/publish"",""method"":""PATCH"",""outcome"":""Publish or unpublish content in a Simpplr site"",""domain"":""content"",""requiredParams"":[""siteId"",""contentId""],""optionalParams"":[""action""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""siteId\"":{\""type\"":\""string\""},\""contentId\"":{\""type\"":\""string\""},\""action\"":{\""type\"":\""string\"",\""enum\"":[\""publish\"",\""unpublish\""]}},\""required\"":[\""siteId\"",\""contentId\""]}""},
        {""cid"":""add_event"",""endpoint"":""/content/sites/{siteId}/content/event"",""method"":""POST"",""outcome"":""Add a new event to a Simpplr site"",""domain"":""content"",""requiredParams"":[""siteId""],""optionalParams"":[""title"",""description"",""startDate"",""endDate"",""location""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""siteId\"":{\""type\"":\""string\""},\""title\"":{\""type\"":\""string\""},\""description\"":{\""type\"":\""string\""},\""startDate\"":{\""type\"":\""string\""},\""endDate\"":{\""type\"":\""string\""},\""location\"":{\""type\"":\""string\""}},\""required\"":[\""siteId\""]}""},
        {""cid"":""add_album"",""endpoint"":""/content/sites/{siteId}/content/album"",""method"":""POST"",""outcome"":""Add a new album to a Simpplr site"",""domain"":""content"",""requiredParams"":[""siteId""],""optionalParams"":[""title"",""description""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""siteId\"":{\""type\"":\""string\""},\""title\"":{\""type\"":\""string\""},\""description\"":{\""type\"":\""string\""}},\""required\"":[\""siteId\""]}""},
        {""cid"":""get_page_categories"",""endpoint"":""/content/sites/{siteId}/content/page/categories"",""method"":""GET"",""outcome"":""Get page categories for a Simpplr site"",""domain"":""content"",""requiredParams"":[""siteId""],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""siteId\"":{\""type\"":\""string\""}},\""required\"":[\""siteId\""]}""},
        {""cid"":""create_feed"",""endpoint"":""/feed"",""method"":""POST"",""outcome"":""Create a new feed post in Simpplr"",""domain"":""feed"",""requiredParams"":[],""optionalParams"":[""body"",""siteId"",""audienceId""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""body\"":{\""type\"":\""string\""},\""siteId\"":{\""type\"":\""string\""},\""audienceId\"":{\""type\"":\""string\""}}}""},
        {""cid"":""get_feeds"",""endpoint"":""/feed"",""method"":""GET"",""outcome"":""Get feed posts from Simpplr"",""domain"":""feed"",""requiredParams"":[],""optionalParams"":[""limit"",""offset""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""limit\"":{\""type\"":\""integer\""},\""offset\"":{\""type\"":\""integer\""}}}""},
        {""cid"":""get_feed"",""endpoint"":""/feed/{feedId}"",""method"":""GET"",""outcome"":""Get a specific feed post by ID"",""domain"":""feed"",""requiredParams"":[""feedId""],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""feedId\"":{\""type\"":\""string\""}},\""required\"":[\""feedId\""]}""},
        {""cid"":""update_feed"",""endpoint"":""/feed/{feedId}"",""method"":""PUT"",""outcome"":""Update an existing feed post"",""domain"":""feed"",""requiredParams"":[""feedId""],""optionalParams"":[""body""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""feedId\"":{\""type\"":\""string\""},\""body\"":{\""type\"":\""string\""}},\""required\"":[\""feedId\""]}""},
        {""cid"":""delete_feed"",""endpoint"":""/feed/{feedId}"",""method"":""DELETE"",""outcome"":""Delete a feed post"",""domain"":""feed"",""requiredParams"":[""feedId""],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""feedId\"":{\""type\"":\""string\""}},\""required\"":[\""feedId\""]}""},
        {""cid"":""create_comment"",""endpoint"":""/feed/{feedId}/comment"",""method"":""POST"",""outcome"":""Add a comment to a feed post"",""domain"":""feed"",""requiredParams"":[""feedId""],""optionalParams"":[""body""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""feedId\"":{\""type\"":\""string\""},\""body\"":{\""type\"":\""string\""}},\""required\"":[\""feedId\""]}""},
        {""cid"":""get_comments"",""endpoint"":""/feed/{feedId}/comment"",""method"":""GET"",""outcome"":""Get comments on a feed post"",""domain"":""feed"",""requiredParams"":[""feedId""],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""feedId\"":{\""type\"":\""string\""}},\""required\"":[\""feedId\""]}""},
        {""cid"":""get_sites"",""endpoint"":""/sites"",""method"":""GET"",""outcome"":""Get list of Simpplr sites"",""domain"":""sites"",""requiredParams"":[],""optionalParams"":[""limit"",""offset""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""limit\"":{\""type\"":\""integer\""},\""offset\"":{\""type\"":\""integer\""}}}""},
        {""cid"":""add_site"",""endpoint"":""/sites"",""method"":""POST"",""outcome"":""Create a new Simpplr site"",""domain"":""sites"",""requiredParams"":[""name""],""optionalParams"":[""description"",""categoryId""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""name\"":{\""type\"":\""string\""},\""description\"":{\""type\"":\""string\""},\""categoryId\"":{\""type\"":\""string\""}},\""required\"":[\""name\""]}""},
        {""cid"":""update_site"",""endpoint"":""/sites/{siteId}"",""method"":""PUT"",""outcome"":""Update an existing Simpplr site"",""domain"":""sites"",""requiredParams"":[""siteId""],""optionalParams"":[""name"",""description""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""siteId\"":{\""type\"":\""string\""},\""name\"":{\""type\"":\""string\""},\""description\"":{\""type\"":\""string\""}},\""required\"":[\""siteId\""]}""},
        {""cid"":""update_site_status"",""endpoint"":""/sites/{siteId}/status"",""method"":""PATCH"",""outcome"":""Update the status of a Simpplr site (activate/deactivate)"",""domain"":""sites"",""requiredParams"":[""siteId""],""optionalParams"":[""status""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""siteId\"":{\""type\"":\""string\""},\""status\"":{\""type\"":\""string\""}},\""required\"":[\""siteId\""]}""},
        {""cid"":""manage_membership"",""endpoint"":""/sites/{siteId}/membership"",""method"":""POST"",""outcome"":""Add or remove members from a Simpplr site"",""domain"":""sites"",""requiredParams"":[""siteId""],""optionalParams"":[""action"",""userIds""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""siteId\"":{\""type\"":\""string\""},\""action\"":{\""type\"":\""string\"",\""enum\"":[\""add\"",\""remove\""]},\""userIds\"":{\""type\"":\""array\"",\""items\"":{\""type\"":\""string\""}}},\""required\"":[\""siteId\""]}""},
        {""cid"":""get_site_members"",""endpoint"":""/sites/{siteId}/members"",""method"":""GET"",""outcome"":""Get members of a Simpplr site"",""domain"":""sites"",""requiredParams"":[""siteId""],""optionalParams"":[""limit"",""offset""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""siteId\"":{\""type\"":\""string\""},\""limit\"":{\""type\"":\""integer\""},\""offset\"":{\""type\"":\""integer\""}},\""required\"":[\""siteId\""]}""},
        {""cid"":""get_site_categories"",""endpoint"":""/sites/categories"",""method"":""GET"",""outcome"":""Get site categories"",""domain"":""sites"",""requiredParams"":[],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{}}""},
        {""cid"":""create_site_category"",""endpoint"":""/sites/categories"",""method"":""POST"",""outcome"":""Create a new site category"",""domain"":""sites"",""requiredParams"":[""name""],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""name\"":{\""type\"":\""string\""}},\""required\"":[\""name\""]}""},
        {""cid"":""get_users"",""endpoint"":""/identity/users"",""method"":""GET"",""outcome"":""Get list of Simpplr users"",""domain"":""users"",""requiredParams"":[],""optionalParams"":[""limit"",""offset"",""search""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""limit\"":{\""type\"":\""integer\""},\""offset\"":{\""type\"":\""integer\""},\""search\"":{\""type\"":\""string\""}}}""},
        {""cid"":""create_user"",""endpoint"":""/identity/users"",""method"":""POST"",""outcome"":""Create a new Simpplr user"",""domain"":""users"",""requiredParams"":[""email""],""optionalParams"":[""firstName"",""lastName"",""role""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""email\"":{\""type\"":\""string\""},\""firstName\"":{\""type\"":\""string\""},\""lastName\"":{\""type\"":\""string\""},\""role\"":{\""type\"":\""string\""}},\""required\"":[\""email\""]}""},
        {""cid"":""get_user"",""endpoint"":""/identity/users/{userId}"",""method"":""GET"",""outcome"":""Get a specific user by ID"",""domain"":""users"",""requiredParams"":[""userId""],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""userId\"":{\""type\"":\""string\""}},\""required\"":[\""userId\""]}""},
        {""cid"":""update_user"",""endpoint"":""/identity/users/{userId}"",""method"":""PATCH"",""outcome"":""Update a Simpplr user (delta update)"",""domain"":""users"",""requiredParams"":[""userId""],""optionalParams"":[""firstName"",""lastName"",""role""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""userId\"":{\""type\"":\""string\""},\""firstName\"":{\""type\"":\""string\""},\""lastName\"":{\""type\"":\""string\""},\""role\"":{\""type\"":\""string\""}},\""required\"":[\""userId\""]}""},
        {""cid"":""get_audiences"",""endpoint"":""/identity/audiences"",""method"":""GET"",""outcome"":""Get list of Simpplr audiences"",""domain"":""audiences"",""requiredParams"":[],""optionalParams"":[""limit"",""offset""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""limit\"":{\""type\"":\""integer\""},\""offset\"":{\""type\"":\""integer\""}}}""},
        {""cid"":""create_audience"",""endpoint"":""/identity/audiences"",""method"":""POST"",""outcome"":""Create a new audience"",""domain"":""audiences"",""requiredParams"":[""name""],""optionalParams"":[""description""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""name\"":{\""type\"":\""string\""},\""description\"":{\""type\"":\""string\""}},\""required\"":[\""name\""]}""},
        {""cid"":""get_audience"",""endpoint"":""/identity/audiences/{audienceId}"",""method"":""GET"",""outcome"":""Get a specific audience by ID"",""domain"":""audiences"",""requiredParams"":[""audienceId""],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""audienceId\"":{\""type\"":\""string\""}},\""required\"":[\""audienceId\""]}""},
        {""cid"":""delete_audience"",""endpoint"":""/identity/audiences/{audienceId}"",""method"":""DELETE"",""outcome"":""Delete an audience"",""domain"":""audiences"",""requiredParams"":[""audienceId""],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""audienceId\"":{\""type\"":\""string\""}},\""required\"":[\""audienceId\""]}""},
        {""cid"":""update_audience"",""endpoint"":""/identity/audiences/{audienceId}"",""method"":""PATCH"",""outcome"":""Update an existing audience"",""domain"":""audiences"",""requiredParams"":[""audienceId""],""optionalParams"":[""name"",""description""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""audienceId\"":{\""type\"":\""string\""},\""name\"":{\""type\"":\""string\""},\""description\"":{\""type\"":\""string\""}},\""required\"":[\""audienceId\""]}""},
        {""cid"":""search_alerts"",""endpoint"":""/alerts"",""method"":""GET"",""outcome"":""Search for alerts in Simpplr"",""domain"":""alerts"",""requiredParams"":[],""optionalParams"":[""status"",""limit"",""offset""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""status\"":{\""type\"":\""string\""},\""limit\"":{\""type\"":\""integer\""},\""offset\"":{\""type\"":\""integer\""}}}""},
        {""cid"":""create_alert"",""endpoint"":""/alerts"",""method"":""POST"",""outcome"":""Create a new alert"",""domain"":""alerts"",""requiredParams"":[""title""],""optionalParams"":[""body"",""type"",""severity""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""title\"":{\""type\"":\""string\""},\""body\"":{\""type\"":\""string\""},\""type\"":{\""type\"":\""string\""},\""severity\"":{\""type\"":\""string\""}},\""required\"":[\""title\""]}""},
        {""cid"":""update_alert"",""endpoint"":""/alerts/{alertId}"",""method"":""PUT"",""outcome"":""Update an existing alert"",""domain"":""alerts"",""requiredParams"":[""alertId""],""optionalParams"":[""title"",""body"",""status""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""alertId\"":{\""type\"":\""string\""},\""title\"":{\""type\"":\""string\""},\""body\"":{\""type\"":\""string\""},\""status\"":{\""type\"":\""string\""}},\""required\"":[\""alertId\""]}""},
        {""cid"":""delete_alert"",""endpoint"":""/alerts/{alertId}"",""method"":""DELETE"",""outcome"":""Delete an alert"",""domain"":""alerts"",""requiredParams"":[""alertId""],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""alertId\"":{\""type\"":\""string\""}},\""required\"":[\""alertId\""]}""},
        {""cid"":""list_notifications"",""endpoint"":""/notifications"",""method"":""GET"",""outcome"":""List all notifications"",""domain"":""notifications"",""requiredParams"":[],""optionalParams"":[""limit"",""offset""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""limit\"":{\""type\"":\""integer\""},\""offset\"":{\""type\"":\""integer\""}}}""},
        {""cid"":""create_notification"",""endpoint"":""/notifications"",""method"":""POST"",""outcome"":""Create a new notification"",""domain"":""notifications"",""requiredParams"":[""title""],""optionalParams"":[""body"",""targetUsers""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""title\"":{\""type\"":\""string\""},\""body\"":{\""type\"":\""string\""},\""targetUsers\"":{\""type\"":\""array\"",\""items\"":{\""type\"":\""string\""}}},\""required\"":[\""title\""]}""},
        {""cid"":""get_recognition_list"",""endpoint"":""/recognition/list"",""method"":""POST"",""outcome"":""Get list of recognition entries"",""domain"":""recognition"",""requiredParams"":[],""optionalParams"":[""limit"",""offset""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""limit\"":{\""type\"":\""integer\""},\""offset\"":{\""type\"":\""integer\""}}}""},
        {""cid"":""enterprise_search"",""endpoint"":""/enterprise-search/search"",""method"":""POST"",""outcome"":""Perform enterprise-wide search across all Simpplr content"",""domain"":""search"",""requiredParams"":[""query""],""optionalParams"":[""type"",""limit"",""offset""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""query\"":{\""type\"":\""string\""},\""type\"":{\""type\"":\""string\""},\""limit\"":{\""type\"":\""integer\""},\""offset\"":{\""type\"":\""integer\""}},\""required\"":[\""query\""]}""},
        {""cid"":""enterprise_autocomplete"",""endpoint"":""/enterprise-search/autocomplete"",""method"":""POST"",""outcome"":""Get autocomplete suggestions for enterprise search"",""domain"":""search"",""requiredParams"":[""query""],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""query\"":{\""type\"":\""string\""}},\""required\"":[\""query\""]}""},
        {""cid"":""smart_answers"",""endpoint"":""/enterprise-search/smartanswers"",""method"":""POST"",""outcome"":""Get AI-powered smart answers from Simpplr content"",""domain"":""search"",""requiredParams"":[""query""],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""query\"":{\""type\"":\""string\""}},\""required\"":[\""query\""]}""},
        {""cid"":""get_workspaces"",""endpoint"":""/service-desk/workspaces"",""method"":""GET"",""outcome"":""Get service desk workspaces"",""domain"":""servicedesk"",""requiredParams"":[],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{}}""},
        {""cid"":""get_ticket_categories"",""endpoint"":""/service-desk/categories"",""method"":""GET"",""outcome"":""Get service desk ticket categories"",""domain"":""servicedesk"",""requiredParams"":[],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{}}""},
        {""cid"":""get_ticket"",""endpoint"":""/service-desk/tickets/{ticketId}"",""method"":""GET"",""outcome"":""Get a specific service desk ticket by ID"",""domain"":""servicedesk"",""requiredParams"":[""ticketId""],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""ticketId\"":{\""type\"":\""string\""}},\""required\"":[\""ticketId\""]}""},
        {""cid"":""create_ticket"",""endpoint"":""/service-desk/tickets"",""method"":""POST"",""outcome"":""Create a new service desk ticket"",""domain"":""servicedesk"",""requiredParams"":[""subject""],""optionalParams"":[""description"",""categoryId"",""priority""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""subject\"":{\""type\"":\""string\""},\""description\"":{\""type\"":\""string\""},\""categoryId\"":{\""type\"":\""string\""},\""priority\"":{\""type\"":\""string\""}},\""required\"":[\""subject\""]}""},
        {""cid"":""update_ticket"",""endpoint"":""/service-desk/tickets/{ticketId}"",""method"":""PUT"",""outcome"":""Update a service desk ticket"",""domain"":""servicedesk"",""requiredParams"":[""ticketId""],""optionalParams"":[""subject"",""description"",""status"",""priority""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""ticketId\"":{\""type\"":\""string\""},\""subject\"":{\""type\"":\""string\""},\""description\"":{\""type\"":\""string\""},\""status\"":{\""type\"":\""string\""},\""priority\"":{\""type\"":\""string\""}},\""required\"":[\""ticketId\""]}""},
        {""cid"":""get_data_exports"",""endpoint"":""/analytics/data-export-requests"",""method"":""GET"",""outcome"":""Get registered data export requests for analytics"",""domain"":""analytics"",""requiredParams"":[],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{}}""},
        {""cid"":""register_data_export"",""endpoint"":""/analytics/data-export-requests"",""method"":""POST"",""outcome"":""Register a new data export request for analytics"",""domain"":""analytics"",""requiredParams"":[""type""],""optionalParams"":[""startDate"",""endDate""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""type\"":{\""type\"":\""string\""},\""startDate\"":{\""type\"":\""string\""},\""endDate\"":{\""type\"":\""string\""}},\""required\"":[\""type\""]}""},
        {""cid"":""list_people"",""endpoint"":""/identity/people"",""method"":""POST"",""outcome"":""List people with search or filter in Simpplr"",""domain"":""people"",""requiredParams"":[],""optionalParams"":[""search"",""limit"",""offset""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""search\"":{\""type\"":\""string\""},\""limit\"":{\""type\"":\""integer\""},\""offset\"":{\""type\"":\""integer\""}}}""},
        {""cid"":""get_files"",""endpoint"":""/files/sites/{siteId}/files"",""method"":""GET"",""outcome"":""Get files from a Simpplr site"",""domain"":""files"",""requiredParams"":[""siteId""],""optionalParams"":[],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""siteId\"":{\""type\"":\""string\""}},\""required\"":[\""siteId\""]}""},
        {""cid"":""add_files"",""endpoint"":""/files/sites/{siteId}/files"",""method"":""POST"",""outcome"":""Add files to a Simpplr site"",""domain"":""files"",""requiredParams"":[""siteId""],""optionalParams"":[""files""],""schemaJson"":""{\""type\"":\""object\"",\""properties\"":{\""siteId\"":{\""type\"":\""string\""},\""files\"":{\""type\"":\""array\"",\""items\"":{\""type\"":\""object\""}}},\""required\"":[\""siteId\""]}""}
    ]";
    ...
    private async Task LogToAppInsights(string eventName, object properties, string correlationId)
    {
        try
        {
            ...
            var ingestionEndpoint = ExtractConnectionStringPart(APP_INSIGHTS_CONNECTION_STRING, "IngestionEndpoint") ?? "https://dc.services.visualstudio.com/";
            if (string.IsNullOrEmpty(instrumentationKey)) return;
            var propsDict = new Dictionary<string, string> { ["ServerName"] = Options.ServerInfo.Name, ["ServerVersion"] = Options.ServerInfo.Version, ["CorrelationId"] = correlationId };
            if (properties != null) { var propsJson = JsonConvert.SerializeObject(properties); var propsObj = JObject.Parse(propsJson); foreach (var prop in propsObj.Properties()) propsDict[prop.Name] = prop.Value?.ToString() ?? ""; }
            var telemetryData = new { name = $"Microsoft.ApplicationInsights.{instrumentationKey}.Event", time = DateTime.UtcNow.ToString("o"), iKey = instrumentationKey, data = new { baseType = "EventData", baseData = new { ver = 2, name = eventName, properties = propsDict } } };
            var json = JsonConvert.SerializeObject(telemetryData);
            var telemetryUrl = new Uri(ingestionEndpoint.TrimEnd('/') + "/v2/track");
            var telemetryRequest = new HttpRequestMessage(HttpMethod.Post, telemetryUrl) { Content = new StringContent(json, Encoding.UTF8, "application/json") };
