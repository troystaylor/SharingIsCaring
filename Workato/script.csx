...
// ╔══════════════════════════════════════════════════════════════════════════════╗
// ║  Workato — Power Mission Control Connector                                 ║
// ║                                                                            ║
// ║  Covers the full Workato Developer API:                                    ║
// ║  Recipes, Connections, Folders, Jobs, Lookup Tables, Data Tables,          ║
// ║  Agent Studio (Genies, Knowledge Bases, Skills), MCP Servers,              ║
// ║  API Collections & Endpoints, API Clients & Keys, Certificate Bundles,     ║
// ║  Developer API Clients, Collaborator Groups, Connectors,                   ║
// ║  Custom Connectors, Custom OAuth Profiles, Environment Management,         ║
// ║  Properties, Roles, Event Streams, Recipe Lifecycle Management,            ║
// ║  Projects, Deployments, Tags, Test Automation,                             ║
// ║  Workspace Collaborators, and Identity IAM.                                ║
// ║                                                                            ║
// ║  MCP exposes high-value operations only. All 225 operations remain         ║
// ║  available as standard Swagger actions in Power Automate.                  ║
// ╚══════════════════════════════════════════════════════════════════════════════╝
...
public class Script : ScriptBase
{
    ...
    private static readonly McpServerOptions Options = new McpServerOptions
    {
        ServerInfo = new McpServerInfo
        {
            ...
            Version = "1.0.0",
            Title = "Workato MCP",
            Description = "Power Mission Control connector for Workato. Manage recipes, connections, jobs, agents, MCP servers, data tables, deployments, and the full workspace automation platform."
        },
    ...
    {
        ServiceName = "workato",
        BaseApiUrl = "", // Set dynamically from connection parameter via dynamichosturl
    ...
    // ── Capability Index (high-value operations for MCP) ─────────────────
    // All 225 operations are available as standard Swagger actions.
    // Only ~50 high-value operations are exposed via MCP for agent use.
    ...
    private const string CAPABILITY_INDEX = @"[
        {
            ...
            ""endpoint"": ""/users/me"",
            ""method"": ""GET"",
            ""outcome"": ""Get current workspace details including plan, name, and ID"",
            ""domain"": ""workspace"",
            ""requiredParams"": [],
            ""optionalParams"": []
        },
        {
            ...
            ""endpoint"": ""/recipes"",
            ""method"": ""GET"",
            ""outcome"": ""List automation recipes with optional filtering by folder, status, or date"",
            ""domain"": ""recipes"",
            ""requiredParams"": [],
            ""optionalParams"": [""folder_id"", ""since"", ""order"", ""running"", ""page"", ""per_page""]
        },
        {
            ""cid"": ""get_recipe"",
            ""endpoint"": ""/recipes/{recipe_id}"",
            ""method"": ""GET"",
            ""outcome"": ""Get details of a specific recipe including its code, trigger, and actions"",
            ""domain"": ""recipes"",
            ""requiredParams"": [""recipe_id""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""start_recipe"",
            ""endpoint"": ""/recipes/{recipe_id}/start"",
            ""method"": ""PUT"",
            ""outcome"": ""Start a recipe so it begins processing triggers"",
            ""domain"": ""recipes"",
            ""requiredParams"": [""recipe_id""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""stop_recipe"",
            ""endpoint"": ""/recipes/{recipe_id}/stop"",
            ""method"": ""PUT"",
            ""outcome"": ""Stop a running recipe"",
            ""domain"": ""recipes"",
            ""requiredParams"": [""recipe_id""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""get_recipe_health"",
            ""endpoint"": ""/recipes/{recipe_id}/health"",
            ""method"": ""GET"",
            ""outcome"": ""Get health status, error counts, and failure details for a recipe"",
            ""domain"": ""recipes"",
            ""requiredParams"": [""recipe_id""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""get_recipe_versions"",
            ""endpoint"": ""/recipes/{recipe_id}/versions"",
            ""method"": ""GET"",
            ""outcome"": ""List version history of a recipe"",
            ""domain"": ""recipes"",
            ""requiredParams"": [""recipe_id""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""list_jobs"",
            ""endpoint"": ""/recipes/{recipe_id}/jobs"",
            ""method"": ""GET"",
            ""outcome"": ""List jobs (execution runs) for a recipe with optional status and date filtering"",
            ""domain"": ""jobs"",
            ""requiredParams"": [""recipe_id""],
            ""optionalParams"": [""from"", ""to"", ""status"", ""rerun_from_job_id"", ""offset""]
        },
        {
            ""cid"": ""get_job"",
            ""endpoint"": ""/recipes/{recipe_id}/jobs/{job_id}"",
            ""method"": ""GET"",
            ""outcome"": ""Get details of a specific job including its status, output, and errors"",
            ""domain"": ""jobs"",
            ""requiredParams"": [""recipe_id"", ""job_id""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""list_connections"",
            ""endpoint"": ""/connections"",
            ""method"": ""GET"",
            ""outcome"": ""List all connections in the workspace with their status and provider"",
            ""domain"": ""connections"",
            ""requiredParams"": [],
            ""optionalParams"": [""page"", ""per_page"", ""folder_id""]
        },
        {
            ""cid"": ""list_folders"",
            ""endpoint"": ""/folders"",
            ""method"": ""GET"",
            ""outcome"": ""List all folders in the workspace for organizing assets"",
            ""domain"": ""folders"",
            ""requiredParams"": [],
            ""optionalParams"": [""parent_id"", ""page"", ""per_page""]
        },
        {
            ""cid"": ""list_projects"",
            ""endpoint"": ""/projects"",
            ""method"": ""GET"",
            ""outcome"": ""List all projects in the workspace"",
            ""domain"": ""projects"",
            ""requiredParams"": [],
            ""optionalParams"": [""page"", ""per_page""]
        },
        {
            ""cid"": ""list_lookup_tables"",
            ""endpoint"": ""/lookup_tables"",
            ""method"": ""GET"",
            ""outcome"": ""List all lookup tables in the workspace"",
            ""domain"": ""lookup_tables"",
            ""requiredParams"": [],
            ""optionalParams"": [""page"", ""per_page""]
        },
        {
            ""cid"": ""lookup_table_entry"",
            ""endpoint"": ""/lookup_tables/{lookup_table_id}/lookup"",
            ""method"": ""GET"",
            ""outcome"": ""Look up a specific entry in a lookup table by key"",
            ""domain"": ""lookup_tables"",
            ""requiredParams"": [""lookup_table_id""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""list_lookup_table_rows"",
            ""endpoint"": ""/lookup_tables/{lookup_table_id}/rows"",
            ""method"": ""GET"",
            ""outcome"": ""List all rows in a lookup table"",
            ""domain"": ""lookup_tables"",
            ""requiredParams"": [""lookup_table_id""],
            ""optionalParams"": [""page"", ""per_page""]
        },
        {
            ""cid"": ""list_genies"",
            ""endpoint"": ""/agentic/genies"",
            ""method"": ""GET"",
            ""outcome"": ""List all Agent Studio genies (AI agents) in the workspace"",
            ""domain"": ""agent_studio"",
            ""requiredParams"": [],
            ""optionalParams"": [""page"", ""per_page""]
        },
        {
            ""cid"": ""get_genie"",
            ""endpoint"": ""/agentic/genies/{id}"",
            ""method"": ""GET"",
            ""outcome"": ""Get details of a specific genie including its skills and knowledge bases"",
            ""domain"": ""agent_studio"",
            ""requiredParams"": [""id""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""start_genie"",
            ""endpoint"": ""/agentic/genies/{id}/start"",
            ""method"": ""POST"",
            ""outcome"": ""Start a genie so it becomes active and available"",
            ""domain"": ""agent_studio"",
            ""requiredParams"": [""id""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""stop_genie"",
            ""endpoint"": ""/agentic/genies/{id}/stop"",
            ""method"": ""POST"",
            ""outcome"": ""Stop an active genie"",
            ""domain"": ""agent_studio"",
            ""requiredParams"": [""id""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""list_knowledge_bases"",
            ""endpoint"": ""/agentic/knowledge_bases"",
            ""method"": ""GET"",
            ""outcome"": ""List all knowledge bases available for genies"",
            ""domain"": ""agent_studio"",
            ""requiredParams"": [],
            ""optionalParams"": [""page"", ""per_page""]
        },
        {
            ""cid"": ""get_knowledge_base"",
            ""endpoint"": ""/agentic/knowledge_bases/{id}"",
            ""method"": ""GET"",
            ""outcome"": ""Get details of a specific knowledge base"",
            ""domain"": ""agent_studio"",
            ""requiredParams"": [""id""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""list_skills"",
            ""endpoint"": ""/agentic/skills"",
            ""method"": ""GET"",
            ""outcome"": ""List all skills available for genies"",
            ""domain"": ""agent_studio"",
            ""requiredParams"": [],
            ""optionalParams"": [""page"", ""per_page""]
        },
        {
            ""cid"": ""list_mcp_servers"",
            ""endpoint"": ""/mcp/mcp_servers"",
            ""method"": ""GET"",
            ""outcome"": ""List all MCP servers configured in the workspace"",
            ""domain"": ""mcp_servers"",
            ""requiredParams"": [],
            ""optionalParams"": [""page"", ""per_page""]
        },
        {
            ""cid"": ""get_mcp_server"",
            ""endpoint"": ""/mcp/mcp_servers/{handle}"",
            ""method"": ""GET"",
            ""outcome"": ""Get details of a specific MCP server including its tools and policies"",
            ""domain"": ""mcp_servers"",
            ""requiredParams"": [""handle""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""list_mcp_server_tools"",
            ""endpoint"": ""/mcp/mcp_servers/{handle}/tools"",
            ""method"": ""GET"",
            ""outcome"": ""List all tools assigned to an MCP server"",
            ""domain"": ""mcp_servers"",
            ""requiredParams"": [""handle""],
            ""optionalParams"": [""page"", ""per_page""]
        },
        {
            ""cid"": ""list_data_tables"",
            ""endpoint"": ""/data_tables"",
            ""method"": ""GET"",
            ""outcome"": ""List all data tables in the workspace"",
            ""domain"": ""data_tables"",
            ""requiredParams"": [],
            ""optionalParams"": [""page"", ""per_page""]
        },
        {
            ""cid"": ""get_data_table"",
            ""endpoint"": ""/data_tables/{data_table_id}"",
            ""method"": ""GET"",
            ""outcome"": ""Get details of a specific data table including its schema"",
            ""domain"": ""data_tables"",
            ""requiredParams"": [""data_table_id""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""list_api_collections"",
            ""endpoint"": ""/api_collections"",
            ""method"": ""GET"",
            ""outcome"": ""List all API collections in the workspace"",
            ""domain"": ""api"",
            ""requiredParams"": [],
            ""optionalParams"": [""page"", ""per_page""]
        },
        {
            ""cid"": ""list_api_endpoints"",
            ""endpoint"": ""/api_endpoints"",
            ""method"": ""GET"",
            ""outcome"": ""List all API endpoints with their status and collection"",
            ""domain"": ""api"",
            ""requiredParams"": [],
            ""optionalParams"": [""api_collection_id"", ""page"", ""per_page""]
        },
        {
            ""cid"": ""list_activity_logs"",
            ""endpoint"": ""/activity_logs"",
            ""method"": ""GET"",
            ""outcome"": ""List workspace activity logs for auditing and troubleshooting"",
            ""domain"": ""environment"",
            ""requiredParams"": [],
            ""optionalParams"": [""from"", ""to"", ""page"", ""per_page""]
        },
        {
            ""cid"": ""list_tags"",
            ""endpoint"": ""/tags"",
            ""method"": ""GET"",
            ""outcome"": ""List all tags used to organize workspace assets"",
            ""domain"": ""environment"",
            ""requiredParams"": [],
            ""optionalParams"": []
        },
        {
            ...
            ""endpoint"": ""/properties"",
            ""method"": ""GET"",
            ""outcome"": ""List all environment properties (key-value configuration)"",
            ""domain"": ""environment"",
            ""requiredParams"": [],
            ""optionalParams"": [""prefix""]
        },
        {
            ""cid"": ""list_event_topics"",
            ""endpoint"": ""/event_streams/topics"",
            ""method"": ""GET"",
            ""outcome"": ""List all event stream topics"",
        ...
        {
            ""cid"": ""get_event_topic"",
            ""endpoint"": ""/event_streams/topics/{topic_id}"",
            ""method"": ""GET"",
            ""outcome"": ""Get details of a specific event stream topic"",
            ""domain"": ""event_streams"",
            ""requiredParams"": [""topic_id""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""list_deployments"",
            ""endpoint"": ""/deployments"",
            ""method"": ""GET"",
            ""outcome"": ""List all deployments and their status (pending, approved, deployed)"",
            ""domain"": ""deployments"",
            ""requiredParams"": [],
            ""optionalParams"": [""page"", ""per_page""]
        },
        {
            ...
            ""method"": ""GET"",
            ""outcome"": ""Get details of a specific deployment including review status"",
            ""domain"": ""deployments"",
            ""requiredParams"": [""id""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""build_project"",
            ""endpoint"": ""/projects/{id}/build"",
            ""method"": ""POST"",
            ""outcome"": ""Build a project to create a deployable artifact"",
            ""domain"": ""deployments"",
            ""requiredParams"": [""id""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""get_project_build"",
            ""endpoint"": ""/project_builds/{id}"",
            ""method"": ""GET"",
            ""outcome"": ""Get the status and details of a project build"",
            ""domain"": ""deployments"",
            ""requiredParams"": [""id""],
            ""optionalParams"": []
        },
        {
            ...
            ""method"": ""GET"",
            ""outcome"": ""List available built-in connectors"",
            ""domain"": ""connectors"",
            ""requiredParams"": [],
            ""optionalParams"": [""page"", ""per_page""]
        },
        {
            ""cid"": ""list_custom_connectors"",
            ""endpoint"": ""/custom_connectors"",
            ""method"": ""GET"",
            ""outcome"": ""List all custom connectors in the workspace"",
            ""domain"": ""connectors"",
            ""requiredParams"": [],
            ""optionalParams"": [""page"", ""per_page""]
        },
        {
            ...
            ""endpoint"": ""/members"",
            ""method"": ""GET"",
            ""outcome"": ""List all workspace collaborators and their roles"",
            ""domain"": ""members"",
            ""requiredParams"": [],
            ""optionalParams"": [""page"", ""per_page""]
        },
        {
            ...
            ""endpoint"": ""/members/{id}"",
            ""method"": ""GET"",
            ""outcome"": ""Get details of a specific workspace member"",
            ""domain"": ""members"",
            ""requiredParams"": [""id""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""run_test_cases"",
            ""endpoint"": ""/test_cases/run_requests"",
            ""method"": ""POST"",
            ""outcome"": ""Run test cases for recipes to validate automation behavior"",
            ""domain"": ""testing"",
            ""requiredParams"": [],
            ""optionalParams"": [""recipe_ids"", ""tag_handles""]
        },
        {
            ""cid"": ""get_test_run"",
            ""endpoint"": ""/test_cases/run_requests/{id}"",
            ""method"": ""GET"",
            ""outcome"": ""Get the status and results of a test case run"",
            ""domain"": ""testing"",
            ""requiredParams"": [""id""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""export_package"",
            ""endpoint"": ""/packages/export/{manifest_id}"",
            ""method"": ""POST"",
            ""outcome"": ""Export a recipe lifecycle management package for deployment"",
            ""domain"": ""rlcm"",
            ""requiredParams"": [""manifest_id""],
            ""optionalParams"": []
        },
        {
            ""cid"": ""get_package"",
            ...
            ""method"": ""GET"",
            ""outcome"": ""Get the status and details of an exported or imported package"",
            ""domain"": ""rlcm"",
            ""requiredParams"": [""id""],
            ""optionalParams"": []
        }
    ...
    {
        // REST operations (non-MCP) pass through directly to Workato API
        ...
        // Derive base URL from the dynamichosturl-rewritten request
        var requestUri = this.Context.Request.RequestUri;
        McOptions.BaseApiUrl = $"{requestUri.Scheme}://{requestUri.Host}/api";

        // Forward auth headers from inbound request to outbound Workato API calls
    ...
    /// <summary>Send a GET request to the Workato API with proper auth headers.</summary>
    private async Task<string> WorkatoApiGetAsync(string path)
    {
    ...
    {
        // Static resource: workspace info (grounding for identity and plan)
        handler.AddResource("workato://workspace", "Workspace Info",
            "Current workspace details including plan, name, and data center. Use this to understand the Workato environment context.",
            handler: async (ct) =>
            {
                var content = await WorkatoApiGetAsync("users/me").ConfigureAwait(false);
                return new JArray { new JObject { ["uri"] = "workato://workspace", ["mimeType"] = "application/json", ["text"] = content } };
            },
            annotationsConfig: a => { a["audience"] = new JArray("assistant"); a["priority"] = 0.9; });

        // Static resource: recipe summary (grounding for what automations exist)
        handler.AddResource("workato://recipes", "Recipe Overview",
            "Summary of all recipes in the workspace with their status (running/stopped), folder, and last run time. Use this to understand available automations.",
            handler: async (ct) =>
            {
                var content = await WorkatoApiGetAsync("recipes?per_page=100").ConfigureAwait(false);
                return new JArray { new JObject { ["uri"] = "workato://recipes", ["mimeType"] = "application/json", ["text"] = content } };
            },
            annotationsConfig: a => { a["audience"] = new JArray("assistant"); a["priority"] = 0.8; });

        // Static resource: connections overview
        handler.AddResource("workato://connections", "Connections Overview",
            "All connections in the workspace with their provider and status. Shows which external services are integrated.",
            handler: async (ct) =>
            {
                var content = await WorkatoApiGetAsync("connections?per_page=100").ConfigureAwait(false);
                return new JArray { new JObject { ["uri"] = "workato://connections", ["mimeType"] = "application/json", ["text"] = content } };
            },
            annotationsConfig: a => { a["audience"] = new JArray("assistant"); a["priority"] = 0.7; });

        // Static resource: projects list
        handler.AddResource("workato://projects", "Projects",
            "All projects in the workspace. Projects organize recipes, connections, and assets for deployment.",
            handler: async (ct) =>
            {
                var content = await WorkatoApiGetAsync("projects?per_page=100").ConfigureAwait(false);
                return new JArray { new JObject { ["uri"] = "workato://projects", ["mimeType"] = "application/json", ["text"] = content } };
            },
            annotationsConfig: a => { a["audience"] = new JArray("assistant"); a["priority"] = 0.6; });

        // Resource template: recipe jobs (execution history for a specific recipe)
        handler.AddResourceTemplate("workato://recipes/{recipe_id}/jobs", "Recipe Jobs",
            "Recent execution history for a specific recipe. Shows job status, timing, and errors.",
            handler: async (uri, ct) =>
            {
                var parameters = McpRequestHandler.ExtractUriParameters("workato://recipes/{recipe_id}/jobs", uri);
                var recipeId = parameters.ContainsKey("recipe_id") ? parameters["recipe_id"] : "";
                var content = await WorkatoApiGetAsync($"recipes/{Uri.EscapeDataString(recipeId)}/jobs").ConfigureAwait(false);
                return new JArray { new JObject { ["uri"] = uri, ["mimeType"] = "application/json", ["text"] = content } };
            },
            annotationsConfig: a => { a["audience"] = new JArray("assistant"); a["priority"] = 0.7; });

        // Resource template: recipe health
        handler.AddResourceTemplate("workato://recipes/{recipe_id}/health", "Recipe Health",
            "Health status for a specific recipe including error counts and failure analysis.",
            handler: async (uri, ct) =>
            {
                var parameters = McpRequestHandler.ExtractUriParameters("workato://recipes/{recipe_id}/health", uri);
                var recipeId = parameters.ContainsKey("recipe_id") ? parameters["recipe_id"] : "";
                var content = await WorkatoApiGetAsync($"recipes/{Uri.EscapeDataString(recipeId)}/health").ConfigureAwait(false);
                return new JArray { new JObject { ["uri"] = uri, ["mimeType"] = "application/json", ["text"] = content } };
            },
            annotationsConfig: a => { a["audience"] = new JArray("assistant"); a["priority"] = 0.8; });

        // Static resource: Agent Studio genies
        handler.AddResource("workato://genies", "Agent Studio Genies",
            "All AI agent genies in the workspace with their status and assigned skills.",
            handler: async (ct) =>
            {
                var content = await WorkatoApiGetAsync("agentic/genies?per_page=100").ConfigureAwait(false);
                return new JArray { new JObject { ["uri"] = "workato://genies", ["mimeType"] = "application/json", ["text"] = content } };
            },
            annotationsConfig: a => { a["audience"] = new JArray("assistant"); a["priority"] = 0.6; });
    }
